/**
   Class for store oauth tokens in memory.
 */
...
OAuthMemoryStore.prototype.addRequestToken = function (token) {
    this._addToken(token, this.requestTokens);
}
...
OAuthMemoryStore.prototype.addAccessToken = function (token) {
    this._addToken(token, this.accessTokens);
}
...
/**
   ...
   @api public
 */
OAuthMemoryStore.prototype.removeAccessToken = function (token) {
    this._removeToken(token, this.accessTokens);
}


module.exports = OAuthMemoryStore;